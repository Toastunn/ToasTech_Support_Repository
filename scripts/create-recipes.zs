...
//adding recipes (refer to https://docs.blamejared.com/1.20.1/en/mods/CreateTweaker/SplashingManager for recipe managers)
  ...
  //Item Application | if you add a recipe from <recipetype:create:item_application>, it will also add it to <recipetype:create:deploying>, but not vice-versa. The recipe created will have using_deployer atteched to it.
    //deploying | <recipetype:create:deploying>.addRecipe(name as string, processedItem as IIngredient, heldItem as IIngredient, outputs as Percentaged<IItemStack>[], keepHeldItem as boolean);
      <recipetype:create:deploying>.addRecipe("copper_casing_w/_plate", <tag:items:create:vanilla_stripped_wood>, <tag:items:forge:plates/copper>, [<item:create:copper_casing> % 100], false);
