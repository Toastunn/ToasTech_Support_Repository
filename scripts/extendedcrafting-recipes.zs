...
//adding recipes
  ...
  //tables <recipetype:extendedcrafting:table>.addShaped(name, tier, <output>, [array]); 
    ...
    //7x7 | elite (tier 3)
      ...
      <recipetype:extendedcrafting:table>.addShaped("portal_frame", 3, <item:kubejs:portal_frame>, [
        [<item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:mekanismgenerators:turbine_vent>, <item:mekanism:teleportation_core>, <item:ae2:crystal_resonance_generator>, <item:ae2:energy_acceptor>, <item:mekanismgenerators:turbine_vent>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:ae2:energy_acceptor>, <item:alltheores:signalum_plate>, <item:alltheores:signalum_plate>, <item:alltheores:signalum_plate>, <item:mekanism:teleportation_core>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:ae2:crystal_resonance_generator>, <item:alltheores:signalum_plate>, <item:ae2:spatial_anchor>, <item:alltheores:signalum_plate>, <item:ae2:crystal_resonance_generator>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:mekanism:teleportation_core>, <item:alltheores:signalum_plate>, <item:alltheores:signalum_plate>, <item:alltheores:signalum_plate>,  <item:ae2:energy_acceptor>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:mekanismgenerators:turbine_vent>, <item:ae2:energy_acceptor>, <item:ae2:crystal_resonance_generator>, <item:mekanism:teleportation_core>, <item:mekanismgenerators:turbine_vent>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>]]);
    //9x9 | ultimate (tier 4)
      ...
      <recipetype:extendedcrafting:table>.addShaped("neutronium_water_source", 4, <item:watersources:water_source_tier_4>, [
        ...
        [<item:mekanismgenerators:reactor_glass>, <item:minecraft:water_bucket>, <item:minecraft:water_bucket>, <item:minecraft:water_bucket>, <item:minecraft:water_bucket>, <item:minecraft:water_bucket>, <item:minecraft:water_bucket>, <item:minecraft:water_bucket> ,<item:mekanismgenerators:reactor_glass>],
        [<item:avaritia:neutron>, <item:avaritia:neutron>, <item:avaritia:neutron>, <item:avaritia:neutron>, <item:avaritia:neutron>, <item:avaritia:neutron>, <item:avaritia:neutron>, <item:avaritia:neutron>, <item:avaritia:neutron>]]);
      <recipetype:extendedcrafting:table>.addShaped("portal_controller", 4, <item:kubejs:portal_controller>, [
        [<item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:ae2:energy_acceptor>, <item:mekanismgenerators:turbine_vent>, <item:mekanism:teleportation_core>, <item:ae2:crystal_resonance_generator>, <item:mekanism:teleportation_core>, <item:mekanismgenerators:turbine_vent>, <item:ae2:energy_acceptor>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:ae2:energy_acceptor>, <item:mekanism:ultimate_energy_cube>, <item:alltheores:signalum_plate>, <item:alltheores:signalum_plate>, <item:alltheores:signalum_plate>, <item:mekanism:ultimate_energy_cube>, <item:ae2:energy_acceptor>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:ae2:spatial_pylon>, <item:mekanism:dimensional_stabilizer>, <item:ae2:engineering_processor>, <item:create_connected:control_chip>, <item:ae2:wireless_terminal>, <item:mekanism:dimensional_stabilizer>, <item:ae2:spatial_pylon>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:ae2:spatial_pylon>, <item:ae2:spatial_cell_component_16>, <tag:items:ae2:smart_cable>, <item:ae2:logic_processor>, <tag:items:ae2:smart_cable>, <item:ae2:spatial_cell_component_16>, <item:ae2:spatial_pylon>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:ae2:spatial_pylon>, <tag:items:ae2:smart_cable>, <tag:items:ae2:smart_cable>, <item:mekanism:network_reader>, <tag:items:ae2:smart_cable>, <tag:items:ae2:smart_cable>, <item:ae2:spatial_pylon>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:createchromaticreturn:andesite_component>, <item:createcasing:creative_adjustable_chain_gearshift>, <item:createchromaticreturn:andesite_component>, <item:kubejs:creativium>, <item:createchromaticreturn:andesite_component>, <item:createcasing:creative_adjustable_chain_gearshift>, <item:createchromaticreturn:andesite_component>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:mekanismgenerators:turbine_vent>, <item:avaritia:neutron_gear>, <item:create:mechanical_arm>, <item:ae2:quantum_link>, <item:create:mechanical_arm>, <item:avaritia:neutron_gear>, <item:mekanismgenerators:turbine_vent>, <item:fluxnetworks:flux_block>],
        [<item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>, <item:fluxnetworks:flux_block>]]);
  //flux crafting
